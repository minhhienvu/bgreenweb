...
<head>
  <title>BGreen - Login admin</title>
      ...
      <form action="<?php echo BASEURL; ?>/admin/login" method="POST">
        <div class="col-12 col-md text-center">
          <a href="<?php echo BASEURL ?>">
            <img class="img-fluid pt-2" src="<?php echo BASEURL; ?>/public/assets/img/bgreen.png" alt="banner">
          </a>
          <small class="d-block mb-3 text-muted">BGreen Admin</small>
        </div>
  ...
  <footer class="fixed-bottom text-light">
    <div class="container my-auto">
      <div class="copyright text-center my-auto">
        <span>Copyright © BGreen - Admin 2022</span>
      </div>
    </div>
  </footer>
  </div>
